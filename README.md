...
AI App Bridge 让 AI agent 可以直接接入正在运行的 Android / Flutter 应用。它能操作安卓 / flutter / H5 三端页面 ， 获取安卓 / flutter / H5 三端 View tree / Widget tree / DOM、网络请求和运行日志，让 AI 不只看截图，也能基于真实状态自主迭代开发移动端。
